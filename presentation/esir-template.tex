...
\begin{comment}
Tuan: introduction des conneries qu'on a fait svp
\end{comment}
\PARstart{N}{OTRE} projet s'intègre dans la phase de recherche du projet recherche des réseaux 5G du futur marché. 
